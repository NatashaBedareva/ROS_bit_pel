...
: ${AMENT_CURRENT_PREFIX:="/home/natalia/Documents/STUDING/ROS_bit_pel/install/robot_bringup"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robot_bringup/environment/robot_bringup.sh"
