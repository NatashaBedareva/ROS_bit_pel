...
4. **Комплексная обработка перекрестков** - полноценная реализация ПДД для робота
5. **Расширяемость** - возможность добавления новых типов дорожных знаков и ситуаций
6. **Детальная визуализация** - полный контроль над процессом принятия решений
